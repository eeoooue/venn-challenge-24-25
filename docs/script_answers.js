...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    HintBox: function HintBox(t0, t1) {
      var _ = this;
      _.__HintBox_hexGrid_A = $;
      _._rand = t0;
      _.hashToDisplay = "000000000------00-0000-00-0--0-00-0--0-00-0000-00------000000000";
      _.__HintBox_hintBox_A = $;
      _.container = t1;
    },
    HintBox_addSetterButton_closure: function HintBox_addSetterButton_closure(t0, t1) {
      this.$this = t0;
      this.value = t1;
    },
    ...
    main() {
      var t2, t3, t4, row1, row2, grid,
        _s12_ = "hint-btn-row",
        t1 = document,
        container = t1.getElementById("tall-box");
      if (type$.Element._is(container)) {
        t2 = new A.HintBox(B.C__JSRandom, container);
        t3 = t1.createElement("div");
        t2.__HintBox_hintBox_A = t3;
        J.get$classes$x(t3).add$1(0, "hint-btn-box");
        t4 = J.getInterceptor$x(container);
        t4.get$children(container).add$1(0, t3);
        row1 = t1.createElement("div");
        J.get$classes$x(row1).add$1(0, _s12_);
        J.get$children$x(t3).add$1(0, row1);
        row2 = t1.createElement("div");
        J.get$classes$x(row2).add$1(0, _s12_);
        J.get$children$x(t3).add$1(0, row2);
        t2.addSetterButton$2("A", row1);
        t2.addSetterButton$2("B", row1);
        t2.addSetterButton$2("C", row1);
        t2.addSetterButton$2("D", row1);
        t2.addSetterButton$2("E", row2);
        t2.addSetterButton$2("F", row2);
        t2.addSetterButton$2("G", row2);
        t2.addSetterButton$2("H", row2);
        grid = t1.createElement("div");
        grid.id = "grid-container";
        t4.get$children(container).add$1(0, grid);
        t1 = new A.HexGrid(grid, B.C__JSRandom, new A.HexPalette());
        t1.populate$0();
        t2.__HintBox_hexGrid_A = t1;
        t1.present$1(t2.hashToDisplay);
      }
    }
  },
  B = {};
  ...
  A.HintBox.prototype = {
    getHashForQuestion$1(value) {
      switch (value) {
        case "A":
          return "d27d5e0e3------6f-ce89-ed-0--2-7c-d--f-7b-8866-36------b9531d02e";
        case "B":
          return "7b62e6659------cc-d61e-a1-8--c-63-6--7-d2-a80f-0c------3302da190";
        case "C":
        ...
        case "F":
          return "6af4e0de3------78-483b-5b-3--e-ee-b--6-64-13b3-4d------ea0818105";
        case "G":
          return "a07f74802------31-ff9a-31-7--f-33-d--f-ff-ffc6-a5------eaaf7bc49";
        default:
          return "69b311710------51-38f9-20-8--7-1f-e--0-c7-bcf4-f2------8b0ce72d9";
      }
    },
    addSetterButton$2(value, row) {
      var list, t1,
        button = document.createElement("button");
      button.id = value + "-button";
      B.ButtonElement_methods.set$text(button, value);
      list = button.classList;
      list.contains("hint-btn").toString;
      list.add("hint-btn");
      t1 = type$._ElementEventStreamImpl_MouseEvent;
      A._EventStreamSubscription$(button, "click", t1._eval$1("~(1)?")._as(new A.HintBox_addSetterButton_closure(this, value)), false, t1._precomputed1);
      J.get$children$x(row).add$1(0, button);
    }
  };
  A.HintBox_addSetterButton_closure.prototype = {
    call$1(_) {
      var t1, t2;
      type$.MouseEvent._as(_);
      t1 = this.$this;
      t2 = t1.getHashForQuestion$1(this.value);
      t1.hashToDisplay = t2;
      t1 = t1.__HintBox_hexGrid_A;
...
//# sourceMappingURL=script_answers.js.map
