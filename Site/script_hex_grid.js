...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    DiceInputProcessor: function DiceInputProcessor() {
    },
    DjInputProcessor: function DjInputProcessor(t0) {
      this.judge = t0;
    },
    DjLibrary: function DjLibrary(t0) {
      this.tracks = t0;
    },
    DjSetlistJudge: function DjSetlistJudge(t0) {
      this.library = t0;
    },
    DjTrack$(line) {
      var t1 = new A.DjTrack(),
        parts = line.split(","),
        t2 = parts.length;
      if (0 >= t2)
        return A.ioore(parts, 0);
      t1.__DjTrack_id_A = A.int_parse(parts[0], null);
      if (1 >= t2)
        return A.ioore(parts, 1);
      if (2 >= t2)
        return A.ioore(parts, 2);
      t1.__DjTrack_bpm_A = A.int_parse(parts[2], null);
      if (3 >= t2)
        return A.ioore(parts, 3);
      t1.__DjTrack_hour_A = parts[3];
      return t1;
    },
    DjTrack: function DjTrack() {
      this.__DjTrack_hour_A = this.__DjTrack_bpm_A = this.__DjTrack_id_A = $;
    },
    HexGrid: function HexGrid(t0, t1, t2) {
      this.container = t0;
      this.randomizer = t1;
      this.palette = t2;
    },
    HexPalette: function HexPalette() {
    },
    InputProcessor: function InputProcessor() {
    },
    LetterScorer: function LetterScorer(t0) {
      this.scoringScheme = t0;
    },
    PuzzleBox: function PuzzleBox(t0, t1, t2) {
      var _ = this;
      _.__PuzzleBox__select_A = _.__PuzzleBox_hexGrid_A = $;
      _._rand = t0;
      _.hashToDisplay = _.inputFieldValue = "";
      _._inputProcessor = t1;
      _.container = t2;
    },
    PuzzleBox_addAnswerField_closure: function PuzzleBox_addAnswerField_closure(t0, t1) {
      this.$this = t0;
      this.element = t1;
    },
    PuzzleBox_addGenerateHashButton_closure: function PuzzleBox_addGenerateHashButton_closure(t0) {
      this.$this = t0;
    },
    printString(string) {
    ...
    main() {
      var t2, grid, t3, t4, select, _null = null,
        t1 = document,
        container = t1.getElementById("tall-box");
      if (type$.Element._is(container)) {
        t2 = new A.PuzzleBox(B.C__JSRandom, new A.InputProcessor(), container);
        grid = t1.createElement("div");
        grid.id = "grid-container";
        t3 = J.getInterceptor$x(container);
        t3.get$children(container).add$1(0, grid);
        t4 = new A.HexGrid(grid, B.C__JSRandom, new A.HexPalette());
        t4.populate$0();
        t2.__PuzzleBox_hexGrid_A = t4;
        select = t1.createElement("select");
        select.id = "question-selector";
        select.children.toString;
        A._ChildrenElementList__addAll(select, type$.Iterable_Element._as(A._setArrayType([A.OptionElement_OptionElement$_("Question A", "1", _null, false), A.OptionElement_OptionElement$_("Question B", "2", _null, false), A.OptionElement_OptionElement$_("Question C", "3", _null, false), A.OptionElement_OptionElement$_("Question D", "4", _null, false), A.OptionElement_OptionElement$_("Question E", "5", _null, false), A.OptionElement_OptionElement$_("Question F", "6", _null, false), A.OptionElement_OptionElement$_("Question G", "7", _null, false), A.OptionElement_OptionElement$_("Question H", "8", _null, false)], type$.JSArray_Element)));
        t3.get$children(container).add$1(0, select);
        t2.__PuzzleBox__select_A = select;
        t2.addAnswerField$0();
        t2.addGenerateHashButton$0();
        t2.presentHash$0();
      }
    }
  },
  ...
  A.NativeByteBuffer.prototype = {
    ...
    asUint8List$2(receiver, offsetInBytes, $length) {
      ...
      t1 = new Uint8Array(receiver, offsetInBytes);
      return t1;
    },
  ...
  A._UnmodifiableNativeByteBufferView.prototype = {
    asUint8List$0(_) {
      var result = A.NativeUint8List_NativeUint8List$view(this._data, 0, null);
      result.$flags = 3;
      return result;
    },
  ...
  A.HashSink.prototype = {
    ...
    _iterate$0() {
      var t3, t4, i, j, t5,
        ...
        pendingDataBytes = J.asByteData$0$x(B.NativeUint8List_methods.get$buffer(t1._buffer)),
    ...
    _finalizeData$0() {
      ...
      byteData = J.asByteData$0$x(B.NativeUint8List_methods.get$buffer(t1._buffer));
  ...
  A.TypedDataBuffer.prototype = {
    ...
    set$length(_, newLength) {
      ...
      if (newLength < t1)
        for (t2 = _this._buffer, t3 = t2.$flags | 0, i = newLength; i < t1; ++i) {
    ...
    _addAll$3(values, start, end) {
      ...
      if (end != null) {
        ...
        B.NativeUint8List_methods.setRange$4(_this._buffer, t1, newLength, values, start);
        _this._typed_buffer$_length = newLength;
        return;
      }
    ...
    set$_buffer(_buffer) {
      this._buffer = A._instanceType(this)._eval$1("TypedDataList<TypedDataBuffer.E>")._as(_buffer);
    }
  };
  A._IntBuffer.prototype = {};
  A.Uint8Buffer.prototype = {};
  A.DiceInputProcessor.prototype = {
    processInput$1(text) {
      var result0, _this = this,
        scoringScheme = _this.wrapInputToLength26$1(_this.getHexadecimalCharsOnly$1(text)),
        t1 = type$.String,
        result = J.JSArray_JSArray$growable(0, t1);
      B.JSArray_methods.add$1(result, "Trope");
      B.JSArray_methods.add$1(result, "Yield");
      B.JSArray_methods.add$1(result, "Diet");
      B.JSArray_methods.add$1(result, "Device");
      B.JSArray_methods.add$1(result, "Medic");
      B.JSArray_methods.add$1(result, "Gene");
      B.JSArray_methods.add$1(result, "Future");
      B.JSArray_methods.add$1(result, "Vibrant");
      B.JSArray_methods.add$1(result, "Figs");
      B.JSArray_methods.add$1(result, "Relate");
      B.JSArray_methods.add$1(result, "Sift");
      B.JSArray_methods.add$1(result, "Carve");
      B.JSArray_methods.add$1(result, "Realise");
      B.JSArray_methods.add$1(result, "Watch");
      B.JSArray_methods.add$1(result, "Whisper");
      B.JSArray_methods.add$1(result, "Endure");
      B.JSArray_methods.add$1(result, "Charge");
      B.JSArray_methods.add$1(result, "Regal");
      B.JSArray_methods.add$1(result, "Sources");
      B.JSArray_methods.add$1(result, "Olden");
      B.JSArray_methods.add$1(result, "Coarse");
      B.JSArray_methods.add$1(result, "Twine");
      B.JSArray_methods.add$1(result, "Aft");
      B.JSArray_methods.add$1(result, "Team");
      B.JSArray_methods.add$1(result, "Format");
      B.JSArray_methods.add$1(result, "Draining");
      result0 = J.JSArray_JSArray$growable(0, t1);
      B.JSArray_methods.add$1(result0, "puny");
      B.JSArray_methods.add$1(result0, "shaken");
      B.JSArray_methods.add$1(result0, "confess");
      B.JSArray_methods.add$1(result0, "greater");
      B.JSArray_methods.add$1(result0, "scales");
      B.JSArray_methods.add$1(result0, "reach");
      B.JSArray_methods.add$1(result0, "graph");
      B.JSArray_methods.add$1(result0, "wounded");
      B.JSArray_methods.add$1(result0, "cottage");
      B.JSArray_methods.add$1(result0, "silent");
      B.JSArray_methods.add$1(result0, "ask");
      B.JSArray_methods.add$1(result0, "absorb");
      B.JSArray_methods.add$1(result0, "hound");
      B.JSArray_methods.add$1(result0, "note");
      B.JSArray_methods.add$1(result0, "clearly");
      B.JSArray_methods.add$1(result0, "spilled");
      B.JSArray_methods.add$1(result0, "thwart");
      B.JSArray_methods.add$1(result0, "arrest");
      B.JSArray_methods.add$1(result0, "that");
      B.JSArray_methods.add$1(result0, "about");
      B.JSArray_methods.add$1(result0, "country");
      B.JSArray_methods.add$1(result0, "time");
      B.JSArray_methods.add$1(result0, "allude");
      B.JSArray_methods.add$1(result0, "widow");
      B.JSArray_methods.add$1(result0, "smile");
      B.JSArray_methods.add$1(result0, "corridor");
      result = "" + _this.scoreWordList$2(result, scoringScheme) + "-" + _this.scoreWordList$2(result0, scoringScheme);
      A.print(result);
      if (_this.checkMaintainsOriginalDiceMap$1(scoringScheme))
        return result + "-VALID";
      else
        return result + "-INVALID";
    },
    checkMaintainsOriginalDiceMap$1(scheme) {
      var _this = this;
      if (_this.incorrectLetterAtPosition$3(scheme, 0, "1"))
        return false;
      if (_this.incorrectLetterAtPosition$3(scheme, 2, "3"))
        return false;
      if (_this.incorrectLetterAtPosition$3(scheme, 4, "0"))
        return false;
      if (_this.incorrectLetterAtPosition$3(scheme, 25, "e"))
        return false;
      return true;
    },
    incorrectLetterAtPosition$3(scheme, i, expected) {
      scheme = scheme.toLowerCase();
      if (!(i < scheme.length))
        return A.ioore(scheme, i);
      return scheme[i] !== expected.toLowerCase();
    },
    scoreWordList$2(words, scoringScheme) {
      var scorer, t1, total, _i;
      type$.List_String._as(words);
      scorer = new A.LetterScorer(scoringScheme);
      for (t1 = words.length, total = 0, _i = 0; _i < words.length; words.length === t1 || (0, A.throwConcurrentModificationError)(words), ++_i)
        total += scorer.scoreWord$1(words[_i]);
      return total;
    },
    getHexadecimalCharsOnly$1(text) {
      var t1, result, i, x, t2;
      text = text.toUpperCase();
      for (t1 = text.length, result = "", i = 0; i < t1; ++i) {
        x = text[i];
        t2 = A.RegExp_RegExp("[0-9A-F]");
        if (t2._nativeRegExp.test(x))
          result += x;
      }
      return result;
    },
    wrapInputToLength26$1(input) {
      if (input.length === 0)
        input = "None";
      for (; input.length < 26;)
        input += input;
      return B.JSString_methods.substring$2(input, 0, 26);
    }
  };
  A.DjInputProcessor.prototype = {
    getTrackUniquenessIndicator$1(setlist) {
      if (this.judge.CheckSongsAreUnique$1(type$.List_int._as(setlist)))
        return "UNIQUE";
      return "REPETITION";
    },
    extractSongIds$1(text) {
      var t1, _i, parsed,
        parts = text.split(","),
        ids = A._setArrayType([], type$.JSArray_int);
      for (t1 = parts.length, _i = 0; _i < t1; ++_i) {
        parsed = A.Primitives_parseInt(B.JSString_methods.trim$0(parts[_i]), null);
        if (parsed != null)
          B.JSArray_methods.add$1(ids, parsed);
      }
      return ids;
    }
  };
  A.DjLibrary.prototype = {
    getTrack$1(id) {
      var t1, t2, _i, track, t3;
      for (t1 = this.tracks, t2 = t1.length, _i = 0; _i < t2; ++_i) {
        track = t1[_i];
        t3 = track.__DjTrack_id_A;
        t3 === $ && A.throwLateFieldNI("id");
        if (t3 === id)
          return track;
      }
      return null;
  ...
  A.DjSetlistJudge.prototype = {
    CheckSongsAreUnique$1(setlist) {
      var songs, expected, _i;
      type$.List_int._as(setlist);
      songs = A.HashSet_HashSet(type$.int);
      expected = setlist.length;
      for (_i = 0; _i < setlist.length; setlist.length === expected || (0, A.throwConcurrentModificationError)(setlist), ++_i)
        songs.add$1(0, setlist[_i]);
      return songs._collection$_length === expected;
    },
    CountValidTransitions$1(setlist) {
      var t1, total, i, t2, trackA;
      type$.List_int._as(setlist);
      for (t1 = setlist.length - 1, total = 0, i = 0; i < t1;) {
        t2 = setlist.length;
        if (!(i < t2))
          return A.ioore(setlist, i);
        trackA = setlist[i];
        ++i;
        if (!(i < t2))
          return A.ioore(setlist, i);
        if (this.TransitionIsValid$2(trackA, setlist[i]))
          ++total;
      }
      return total;
    },
    TransitionIsValid$2(trackA_id, trackB_id) {
      var hourA, diff, _this = this,
        t1 = _this.library,
        trackA = t1.getTrack$1(trackA_id),
        trackB = t1.getTrack$1(trackB_id);
      if (trackA instanceof A.DjTrack && trackB instanceof A.DjTrack)
        if (_this.TransitionMeetsTempoCriteria$2(trackA, trackB)) {
          t1 = type$.DjTrack._as(trackA).__DjTrack_hour_A;
          t1 === $ && A.throwLateFieldNI("hour");
          hourA = _this.parseHour$1(t1);
          t1 = trackB.__DjTrack_hour_A;
          t1 === $ && A.throwLateFieldNI("hour");
          diff = Math.abs(hourA - _this.parseHour$1(t1));
          if (diff === 0 || diff === 1 || diff === 23 || diff === 12)
            return true;
        }
      return false;
    },
    TransitionMeetsTempoCriteria$2(trackA, trackB) {
      var t2,
        t1 = trackA.__DjTrack_bpm_A;
      t1 === $ && A.throwLateFieldNI("bpm");
      t2 = trackB.__DjTrack_bpm_A;
      t2 === $ && A.throwLateFieldNI("bpm");
      if (t1 > t2)
        return t1 - t2 <= 2;
      if (t1 < t2)
        return t2 - t1 <= 5;
    ...
    parseHour$1(hourString) {
      var time, hour, isPm,
        parts = hourString.split(" "),
        t1 = parts.length;
      if (0 >= t1)
        return A.ioore(parts, 0);
      time = parts[0].split(":");
      if (0 >= time.length)
        return A.ioore(time, 0);
      hour = A.int_parse(time[0], null);
      if (1 >= t1)
        return A.ioore(parts, 1);
      ...
      if (hour === 12)
        ...
        hour += 12;
      return B.JSInt_methods.$mod(hour, 24);
    }
  };
  A.DjTrack.prototype = {};
  A.HexGrid.prototype = {
    present$1(hash) {
      var t2, i, t3, i0, color, t4,
        t1 = type$.Element;
      A.checkTypeBound(t1, t1, "T", "querySelectorAll");
      t2 = this.container.querySelectorAll(".square");
      for (i = hash.length, t3 = this.palette, i0 = 0; i0 < Math.min(t2.length, i); ++i0) {
        if (!(i0 < i))
          return A.ioore(hash, i0);
        color = t3.ConvertHexCharToHexColour$1(hash[i0]);
        if (!(i0 < t2.length))
          return A.ioore(t2, i0);
        t4 = t1._as(t2[i0]).style;
        t4.background = color;
      }
      for (; i < t2.length; ++i) {
        t3 = t1._as(t2[i]).style;
        t3.background = "#1d1d1d";
      }
    },
    populate$0() {
      var t1, t2, i, square;
      for (t1 = this.container, t2 = t1.children, i = 0; i < 64; ++i) {
        square = document.createElement("div");
        J.get$classes$x(square).add$1(0, "square");
        t2.toString;
        t1.appendChild(square).toString;
      }
    }
  };
  A.HexPalette.prototype = {
    ConvertHexCharToHexColour$1(s) {
      if (s === "-")
        return "White";
      return this._GetColour$1(A.int_parse(s, 16));
    },
    _GetColour$1(i) {
      if (i < 10)
        return this._ConstructColour$1(i);
      else
        return this._LookupRainbow$1(i);
    },
    _ConstructColour$1(index) {
      var result, i;
      for (result = "#", i = 0; i < 6; ++i) {
        if (!(index >= 0 && index < 10))
          return A.ioore("3456789abc", index);
        result += "3456789abc"[index];
      }
      return result;
    },
    _LookupRainbow$1(i) {
  ...
  A.InputProcessor.prototype = {
    getBaseProcessedInput$2(questionId, input) {
      var t1, processor, setlist, result;
      if (questionId === 5)
        return new A.DiceInputProcessor().processInput$1(input);
      else if (questionId === 7) {
        t1 = J.JSArray_JSArray$growable(0, type$.DjTrack);
        B.JSArray_methods.add$1(t1, A.DjTrack$("1,Trap,137,11:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("2,Bass House,121,6:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("3,Trap,143,5:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("4,Drum & Bass,177,2:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("5,Trap,144,4:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("6,Drum & Bass,180,11:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("7,Bass House,127,12:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("8,Electronic,120,4:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("9,Garage,132,11:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("10,Electronic,155,1:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("11,Bass House,129,12:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("12,Drum & Bass,175,7:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("13,Drum & Bass,174,6:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("14,Bass House,128,2:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("15,Trap,142,8:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("16,Trap,139,8:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("17,Electronic,146,12:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("18,Trap,144,7:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("19,Drum & Bass,170,6:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("20,Trap,143,8:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("21,Drum & Bass,170,8:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("22,Drum & Bass,175,9:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("23,Bass House,121,2:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("24,Bass House,126,6:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("25,Bass House,128,4:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("26,Garage,132,9:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("27,Trap,144,4:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("28,Trap,149,12:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("29,Electronic,132,11:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("30,Bass House,128,12:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("31,Trap,138,4:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("32,Bass House,128,12:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("33,Trap,144,7:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("34,Bass House,124,3:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("35,Drum & Bass,177,9:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("36,Drum & Bass,180,4:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("37,Trap,138,11:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("38,Electronic,163,1:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("39,Drum & Bass,180,3:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("40,Trap,141,8:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("41,Deep House,128,2:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("42,Electronic,163,3:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("43,Electronic,173,4:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("44,Trap,140,5:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("45,Bass House,126,4:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("46,Electronic,180,3:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("47,Bass House,123,2:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("48,Trap,148,11:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("49,Trap,140,12:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("50,Bass House,122,10:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("51,Electronic,163,7:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("52,Electronic,159,8:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("53,Trap,138,9:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("54,Trap,145,10:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("55,Electronic,137,6:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("56,Drum & Bass,171,10:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("57,Electronic,159,2:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("58,Electronic,177,10:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("59,Electronic,162,7:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("60,Trap,152,3:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("61,Trap,138,6:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("62,Drum & Bass,172,7:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("63,Trap,138,11:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("64,Electronic,155,7:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("65,Bass House,131,5:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("66,Trap,143,10:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("67,Drum & Bass,170,8:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("68,Trap,150,12:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("69,Electronic,158,8:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("70,Trap,136,6:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("71,Drum & Bass,180,2:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("72,Trap,135,9:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("73,Drum & Bass,173,7:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("74,Trap,139,1:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("75,Deep House,125,1:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("76,Garage,135,6:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("77,Trap,153,3:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("78,Bass House,126,9:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("79,Trap,152,10:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("80,Garage,132,9:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("81,Deep House,126,3:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("82,Trap,152,10:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("83,Trap,137,6:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("84,Dubstep,141,6:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("85,Trap,144,6:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("86,Bass House,122,11:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("87,Garage,132,5:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("88,Electronic,156,12:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("89,Trap,137,10:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("90,Bass House,131,7:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("91,Drum & Bass,173,12:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("92,Trap,144,1:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("93,Trap,152,1:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("94,Electronic,155,10:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("95,Trap,140,9:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("96,Bass House,123,4:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("97,Electronic,163,10:00 AM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("98,Bass House,131,2:00 PM"));
        B.JSArray_methods.add$1(t1, A.DjTrack$("99,Drum & Bass,170,4:00 PM"));
        t1 = new A.DjSetlistJudge(new A.DjLibrary(t1));
        processor = new A.DjInputProcessor(t1);
        setlist = processor.extractSongIds$1(input);
        result = "" + setlist.length + "songs-" + processor.getTrackUniquenessIndicator$1(setlist) + "-" + ("" + t1.CountValidTransitions$1(type$.List_int._as(setlist)) + "GoodTransitions");
        A.print(result);
        return result;
      } else
        return this.processGeneralInput$1(input);
    },
    processGeneralInput$1(input) {
      var buffer, t1, i, char;
      input = input.toUpperCase();
      buffer = new A.StringBuffer("");
      for (t1 = input.length, i = 0; i < t1; ++i) {
        char = input[i];
        if (char !== " ")
          buffer._contents += char;
      }
      t1 = buffer._contents;
      return t1.charCodeAt(0) == 0 ? t1 : t1;
    }
  };
  A.LetterScorer.prototype = {
    scoreWord$1(word) {
      var t1, t2, t3, total, i, t4, alphabeticalIndex;
      for (t1 = word.length, t2 = this.scoringScheme, t3 = t2.length, total = 0, i = 0; i < t1; ++i) {
        t4 = word[i];
        alphabeticalIndex = B.JSString_methods.indexOf$1("ABCDEFGHIJKLMNOPQRSTUVWXYZ", t4.toUpperCase());
        if (alphabeticalIndex === -1)
          A.throwExpression(A.ArgumentError$("Invalid letter: " + t4, null));
        if (!(alphabeticalIndex >= 0 && alphabeticalIndex < t3))
          return A.ioore(t2, alphabeticalIndex);
        total += B.JSString_methods.indexOf$1("0123456789abcdef", t2[alphabeticalIndex].toLowerCase());
      }
      return total;
    }
  };
  A.PuzzleBox.prototype = {
    addAnswerField$0() {
      var t1,
        element = A.InputElement_InputElement();
      B.InputElement_methods.set$type(element, "text");
      element.id = "answer-field";
      element.placeholder = "Enter your answer here";
      element.autocomplete = "off";
      t1 = type$._ElementEventStreamImpl_Event;
      A._EventStreamSubscription$(element, "input", t1._eval$1("~(1)?")._as(new A.PuzzleBox_addAnswerField_closure(this, element)), false, t1._precomputed1);
      J.get$children$x(this.container).add$1(0, element);
      return element;
    },
    getQuestionId$0() {
      var value,
        t1 = this.__PuzzleBox__select_A;
      t1 === $ && A.throwLateFieldNI("_select");
      value = t1.value;
      if (typeof value == "string") {
    ...
    addGenerateHashButton$0() {
      var t1,
        button = document.createElement("button");
      button.id = "generate-hash-button";
      B.ButtonElement_methods.set$text(button, "Generate Hash");
      t1 = type$._ElementEventStreamImpl_MouseEvent;
      A._EventStreamSubscription$(button, "click", t1._eval$1("~(1)?")._as(new A.PuzzleBox_addGenerateHashButton_closure(this)), false, t1._precomputed1);
      J.get$children$x(this.container).add$1(0, button);
    },
    presentHash$0() {
      var t1, _this = this;
      if (_this.inputFieldValue === "")
        _this.hashToDisplay = B.JSString_methods.$mul("0", 64);
      t1 = _this.__PuzzleBox_hexGrid_A;
      t1 === $ && A.throwLateFieldNI("hexGrid");
      t1.present$1(_this.hashToDisplay);
    }
  };
  A.PuzzleBox_addAnswerField_closure.prototype = {
    call$1($event) {
      var t1 = this.element.value;
      if (t1 == null)
        t1 = "";
      this.$this.inputFieldValue = t1;
    },
    $signature: 4
  };
  A.PuzzleBox_addGenerateHashButton_closure.prototype = {
    call$1(_) {
      var t1, qId, t2, innerSink, t3, t4, t5;
      type$.MouseEvent._as(_);
      t1 = this.$this;
      qId = t1.getQuestionId$0();
      t2 = type$.List_int._as(B.C_Utf8Encoder.convert$1("Q" + qId + "-" + t1._inputProcessor.getBaseProcessedInput$2(qId, t1.inputFieldValue)));
      innerSink = new A.DigestSink();
      type$.Sink_Digest._as(innerSink);
      t3 = new Uint32Array(A._ensureNativeList(A._setArrayType([1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225], type$.JSArray_int)));
      t4 = new Uint32Array(64);
      t5 = new A.Uint8Buffer(new Uint8Array(0), 0);
      t3 = new A._Sha256Sink(t3, t4, innerSink, new Uint32Array(16), t5);
      t3._lengthInBytes = t2.length;
      t5.addAll$1(0, t2);
      t3._iterate$0();
      t3.close$0(0);
      t1.hashToDisplay = A._hexEncode(innerSink._value.bytes);
      t1.presentHash$0();
    },
    $signature: 14
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.ListIterator, A.Iterable, A.MappedIterator, A.WhereIterator, A.TakeIterator, A.SkipIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.JSSyntaxRegExp, A._UnmodifiableNativeByteBufferView, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._Zone, A.SetBase, A._HashSetIterator, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.Converter, A._Utf8Encoder, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.CssStyleDeclarationBase, A.EventStreamProvider, A._EventStreamSubscription, A.ImmutableListMixin, A.FixedSizeListIterator, A._JSRandom, A.Endian, A.Digest, A.DigestSink, A.HashSink, A.DiceInputProcessor, A.DjInputProcessor, A.DjLibrary, A.DjSetlistJudge, A.DjTrack, A.HexGrid, A.HexPalette, A.InputProcessor, A.LetterScorer, A.PuzzleBox]);
    ...
    _inheritMany(A.Iterable, [A.MappedIterable, A.WhereIterable, A.TakeIterable, A.SkipIterable]);
    _inherit(A.EfficientLengthTakeIterable, A.TakeIterable);
    _inherit(A.EfficientLengthSkipIterable, A.SkipIterable);
    _inherit(A.NullError, A.TypeError);
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.CssClassSetImpl_add_closure, A.FilteredElementList__iterable_closure, A.FilteredElementList__iterable_closure0, A.FilteredElementList_removeRange_closure, A.PuzzleBox_addAnswerField_closure, A.PuzzleBox_addGenerateHashButton_closure]);
    ...
    _inheritMany(A.ListBase, [A._ChildrenElementList, A._FrozenElementList, A._ChildNodeListLazy, A.FilteredElementList, A.TypedDataBuffer]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "Null(@)", "Null()", "~(Event)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(Object,StackTrace)", "bool(Set<String>)", "bool(Node)", "Element(Node)", "~(Element)", "~(MouseEvent)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","Window":"EventTarget","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","MathMLElement":"Element","HtmlFormControlsCollection":"HtmlCollection","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"Pattern":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"ListIterator":{"Iterator":["1"]},"MappedIterable":{"Iterable":["2"],"Iterable.E":"2"},"MappedIterator":{"Iterator":["2"]},"WhereIterable":{"Iterable":["1"],"Iterable.E":"1"},"WhereIterator":{"Iterator":["1"]},"TakeIterable":{"Iterable":["1"],"Iterable.E":"1"},"EfficientLengthTakeIterable":{"TakeIterable":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"Iterable.E":"1"},"TakeIterator":{"Iterator":["1"]},"SkipIterable":{"Iterable":["1"],"Iterable.E":"1"},"EfficientLengthSkipIterable":{"SkipIterable":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"Iterable.E":"1"},"SkipIterator":{"Iterator":["1"]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JSSyntaxRegExp":{"Pattern":[]},"NativeByteBuffer":{"TrustedGetRuntimeType":[]},"NativeByteData":{"TrustedGetRuntimeType":[]},"NativeTypedArray":{"JavaScriptIndexingBehavior":["1"]},"NativeTypedArrayOfInt":{"ListBase":["int"],"NativeTypedArray":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"]},"NativeUint16List":{"ListBase":["int"],"TypedDataList":["int"],"NativeTypedArray":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"NativeUint32List":{"Uint32List":[],"ListBase":["int"],"TypedDataList":["int"],"NativeTypedArray":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"NativeUint8List":{"Uint8List":[],"ListBase":["int"],"TypedDataList":["int"],"NativeTypedArray":["int"],"List":["int"],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"AsyncError":{"Error":[]},"_Future":{"Future":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"_HashSet":{"SetBase":["1"],"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"_HashSetIterator":{"Iterator":["1"]},"_LinkedHashSet":{"SetBase":["1"],"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"_LinkedHashSetIterator":{"Iterator":["1"]},"ListBase":{"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"SetBase":{"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"_SetBase":{"SetBase":["1"],"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"Utf8Encoder":{"Converter":["String","List<int>"]},"int":{"num":[]},"List":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"Set":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"String":{"Pattern":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"Element":{"Node":[],"EventTarget":[]},"MouseEvent":{"Event":[]},"Node":{"EventTarget":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[]},"ButtonElement":{"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"_ChildrenElementList":{"ListBase":["Element"],"List":["Element"],"EfficientLengthIterable":["Element"],"Iterable":["Element"],"ListBase.E":"Element"},"_FrozenElementList":{"ListBase":["1"],"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"ListBase.E":"1"},"FormElement":{"Element":[],"Node":[],"EventTarget":[]},"HtmlCollection":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListBase.E":"Node"},"InputElement":{"Element":[],"Node":[],"EventTarget":[]},"_ChildNodeListLazy":{"ListBase":["Node"],"List":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ListBase.E":"Node"},"NodeList":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListBase.E":"Node"},"SelectElement":{"Element":[],"Node":[],"EventTarget":[]},"UIEvent":{"Event":[]},"_NamedNodeMap":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListBase.E":"Node"},"_ElementCssClassSet":{"SetBase":["String"],"Set":["String"],"EfficientLengthIterable":["String"],"Iterable":["String"]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"FixedSizeListIterator":{"Iterator":["1"]},"CssClassSetImpl":{"SetBase":["String"],"Set":["String"],"EfficientLengthIterable":["String"],"Iterable":["String"]},"FilteredElementList":{"ListBase":["Element"],"List":["Element"],"EfficientLengthIterable":["Element"],"Iterable":["Element"],"ListBase.E":"Element"},"_JSRandom":{"Random":[]},"AttributeClassSet":{"SetBase":["String"],"Set":["String"],"EfficientLengthIterable":["String"],"Iterable":["String"]},"SvgElement":{"Element":[],"Node":[],"EventTarget":[]},"Uint8List":{"TypedDataList":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Uint16List":{"TypedDataList":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Uint32List":{"TypedDataList":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"DigestSink":{"Sink":["Digest"]},"HashSink":{"Sink":["List<int>"]},"_Sha32BitSink":{"Sink":["List<int>"]},"_Sha256Sink":{"Sink":["List<int>"]},"TypedDataBuffer":{"ListBase":["1"],"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"_IntBuffer":{"TypedDataBuffer":["int"],"ListBase":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Uint8Buffer":{"TypedDataBuffer":["int"],"ListBase":["int"],"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"ListBase.E":"int","TypedDataBuffer.E":"int"}}'));
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "Endian_host", "$get$Endian_host", () => J.asByteData$2$x(B.NativeUint16List_methods.get$buffer(new Uint16Array(A._ensureNativeList(A._setArrayType([1], type$.JSArray_int)))), 0, null).getInt8(0) === 1 ? B.C_Endian0 : B.C_Endian);
  })();
...
//# sourceMappingURL=script_hex_grid.js.map
